<?php
abstract class viewTbp extends baseObjectTbp {
    /* 
     * @deprecated
     */
    protected $_tpl = TBP_DEFAULT;
    /*
	...
	public function getPath($tpl) {
		$path = '';
		$parentModule = frameTbp::_()->getModule( $this->_code );
	...
	public function getModel($code = '') {
		return frameTbp::_()->getModule( $this->_code )->getController()->getModel($code);
	}
