<?php
class userTbp extends moduleTbp {
    ...
    public function isAdmin() {
        ...
        return current_user_can( frameTbp::_()->getModule('adminmenu')->getMainCap() );
    }
	...
	protected function _loadUserData() {
		if(!$this->_dataLoaded) {
			if(!function_exists('wp_get_current_user')) frameTbp::_()->loadPlugins();
	...
	public function getAdminsList() {
		global $wpdb;
		$admins = dbTbp::get('SELECT * FROM #__users 
